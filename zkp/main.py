...
def miner(blockchain):
    while STOP == 0:
        while len(blockchain.blockqueue) >= 1:
            ...
            concent = "update||"+block.conv_block_to_str(0,0)+"||appendix||verification: "+ECC_1.sign_ECDSA_msg(block.get_blockhash(),node.server_port).decode()+"\\miner: "+str(node.server_port)+"\\commitment:["
