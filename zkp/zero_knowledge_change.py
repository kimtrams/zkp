...
if __name__ == "__main__":
    ...
    if random_nonce % 2 == 0:
        ...
        for a in range(len(str(random_nonce))):
            if random_nonce % 10 != 9:
                ...
                print("test4",sender_solution_row)
    ...
    nonce_list = []
    print("test_2",puzzle_rows(nonces))
    print("test_22",type(nonces))
    t = nonce_list.append(puzzle_rows(nonces))
    print("test_222",t)
    #print("test_2222",list(zip(nonces)))
