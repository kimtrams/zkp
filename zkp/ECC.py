...
class Ecc(object):
   def __init__(self):
        ...
        #pri_path = ['privkey_ECC_1.txt','privkey_ECC_2.txt','privkey_ECC_3.txt','privkey_ECC_4.txt']
        #self.public_key_path = ['pubkey_ECC_1.txt','pubkey_ECC_2.txt','pubkey_ECC_3.txt','pubkey_ECC_4.txt']
        #self.privaue_key_path = ['privkey_ECC_4.txt','privkey_ECC_2.txt','privkey_ECC_3.txt','privkey_ECC_4.txt']
        ...
        #self.privaue_key_path = ['privkey_ECC_1.txt','privkey_ECC_2.txt','privkey_ECC_3.txt','privkey_ECC_4.txt']
...
if __name__ == "__main__":
    ...
    #m = "Steganography"
    m = "Steganography"
    m_dec = 9147261539988495532307103377529
    c1=pow(m_dec,e1,n)
    c2=pow(m_dec,e2,n)
    print("n1=",n)
    print("e1=",e1)
    ...
    t_2 = "test 20000002 port 5003"
    t = t_2.encode('utf-8')
    print("dec",t.decode('utf-8'))
    print("dec",t.hex())
    print("dec",type(t.hex()))
    
    t_1 = "7465737420323030303030303220706f72742035303033"
    print("dec",int(t_1, 16))
    print("dec_type",type(int(t_1, 16)))
    print("dec_type",int(t_1, 16) % 3)
